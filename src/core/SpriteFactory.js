...
export const ASSET_REGISTRY = {
    SHEETS: {
        ...
        ITEMS: '/assets/buildings/building4.png',
        ITEMS2: '/assets/buildings/building5.png',
        ITEMS3: '/assets/buildings/building6.png',
        ITEMS4: '/assets/buildings/building7.png',
        ITEMS5: '/assets/buildings/building8.png',
        ...
        SKILL1: '/assets/abilities/common1.png',
        SKILL2: '/assets/abilities/common2.png',
        SKILL3: '/assets/abilities/tiance3.png',
        SKILL4: '/assets/abilities/tiance4.png',
        SKILL5: '/assets/abilities/cangjian3.png',
        SKILL6: '/assets/abilities/cangjian4.png',
        SKILL7: '/assets/abilities/chunyang3.png',
        SKILL8: '/assets/abilities/chunyang4.png',
        TALENT1: '/assets/abilities/common3.png',
        TALENT2: '/assets/abilities/common4.png',
        TALENT3: '/assets/abilities/common5.png',
        TALENT4: '/assets/abilities/common6.png',
        TALENT5: '/assets/abilities/common7.png',
        TALENT6: '/assets/abilities/common8.png',
        TALENT_CANGJIAN: '/assets/abilities/cangjian1.png',
        TALENT_CANGJIAN2: '/assets/abilities/cangjian2.png',
        TALENT_CHUNYANG: '/assets/abilities/chunyang1.png',
        TALENT_CHUNYANG2: '/assets/abilities/chunyang2.png',
        TALENT_TIANCE: '/assets/abilities/tiance1.png',
        TALENT_TIANCE2: '/assets/abilities/tiance2.png',
        TALENT_WANHUA: '/assets/abilities/wanhua1.png',
        BUILDING1: '/assets/buildings/building.png',
    ...
    UNITS: {
        ...
        'chunyang': { name: '纯阳弟子', sheet: 'CHARS1', rows: 4, cols: 4, r: 1, c: 3, scale: 1.4, defaultFacing: 'left' },
