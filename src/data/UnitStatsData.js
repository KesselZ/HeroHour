...
export const UNIT_STATS_DATA = {
    ...
    'healer': { name: '万花弟子', hp: 120, atk: 39, range: 5.0, rangeType: '治疗', speed: 2.7, attackSpeed: 2500, targets: 1.0, allowedZones: ['middle'], description: '妙手回春，能够有效保障精锐部队的存活。' },
    ...
    'zombie': { name: '毒尸傀儡', hp: 250, atk: 12, range: 1.2, rangeType: '近战', speed: 2.0, attackSpeed: 1000, targets: 1.0, allowedZones: ['front'] },
    ...
    'tianyi_crossbowman': { name: '天一弩手', hp: 150, atk: 25, range: 15.0, rangeType: '远程', speed: 3.2, attackSpeed: 2000, targets: 1.0, allowedZones: ['back'] },
    ...
    'tianyi_venom_zombie': { name: '天一毒尸', hp: 350, atk: 10, range: 1.2, rangeType: '近战', speed: 2.2, attackSpeed: 1000, targets: 1.0, allowedZones: ['front'] },
    'tianyi_priest': { name: '天一祭司', hp: 200, atk: 20, range: 10.0, rangeType: '咒术', speed: 3.0, attackSpeed: 2000, targets: 2.0, allowedZones: ['middle'] },
    ...
    'tianyi_elder': { name: '天一长老', hp: 450, atk: 45, range: 12.0, rangeType: '法术', speed: 2.8, attackSpeed: 2200, targets: 1.5, allowedZones: ['middle'] },
    ...
    'shence_crossbowman': { name: '神策弩手', hp: 200, atk: 35, range: 15.0, rangeType: '远程', speed: 3.0, attackSpeed: 2200, targets: 1.0, allowedZones: ['back'] },
    'shence_bannerman': { name: '神策旗手', hp: 420, atk: 22, range: 5.0, rangeType: '增益', speed: 3.6, attackSpeed: 2000, targets: 1.0, allowedZones: ['middle'], description: '神策军的精神支柱，提升周围友军的士气。' },
    ...
    'shence_iron_pagoda': { name: '铁甲神策', hp: 1440, atk: 75, range: 2.2, rangeType: '重装', speed: 1.8, attackSpeed: 2500, mass: 10.0, targets: 3.0, allowedZones: ['front'] },
    ...
    'red_cult_high_priestess': { name: '红衣圣女', hp: 550, atk: 40, range: 12.0, rangeType: '神圣', speed: 3.0, attackSpeed: 1800, targets: 2.0, allowedZones: ['middle'], description: '地位崇高的圣女，周围散发着令人疯狂的狂热气息。' },
    'red_cult_swordsman': { name: '红衣剑卫', hp: 240, atk: 18, range: 1.5, rangeType: '近战', speed: 3.8, attackSpeed: 1000, targets: 1.0, allowedZones: ['front'] },
    'red_cult_archer': { name: '红衣教弩手', hp: 180, atk: 22, range: 15.0, rangeType: '远程', speed: 3.4, attackSpeed: 2000, targets: 1.0, allowedZones: ['back'] },
    ...
    'red_cult_firemage': { name: '红衣法师', hp: 280, atk: 45, range: 8.0, rangeType: '灼烧', speed: 2.8, attackSpeed: 2500, targets: 3.0, allowedZones: ['middle'], description: '红衣教的控火者，能让大片战场陷入火海。' },
    ...
    'red_cult_acolyte': { name: '红衣教众', hp: 150, atk: 12, range: 1.2, rangeType: '狂热', speed: 4.5, attackSpeed: 900, targets: 1.0, allowedZones: ['front'] },
    'red_cult_enforcer': { name: '红衣武者', hp: 200, atk: 16, range: 1.2, rangeType: '近战', speed: 4.8, attackSpeed: 800, targets: 1.0, allowedZones: ['front'] },
    ...
    'tc_mounted_crossbow': { name: '骁骑弩手', hp: 640, atk: 45, range: 14.0, rangeType: '骑射', speed: 6.5, attackSpeed: 2000, targets: 1.0, allowedZones: ['back'], description: '羽林骑精锐，在马上亦能精准射杀敌军。' },
    'tc_heavy_cavalry': { name: '玄甲陷阵骑', hp: 850, atk: 45, range: 2.2, rangeType: '重装冲锋', speed: 5.5, attackSpeed: 1500, targets: 3.0, allowedZones: ['front'], description: '大唐最强重骑，冲锋之时无坚不摧。' },
