 ...
 * 
 * --- 描述高亮规则 ---
 * 1. 蓝色 (<span class="skill-term-highlight">): 被影响者/对象 (如：招式名称、属性名、机制名)
...
export const TALENT_UNITS = {
    ...
    'unit_income_base': {
        ...
        description: '生财有方，每座城池<span class="skill-term-highlight">季度金钱产出</span>提升 <span class="skill-num-highlight">250</span> 点。',
        requires: ['node_core'],
        effects: [{ type: 'modifier', unitType: 'main_city', key: 'gold_income', value: 250, method: 'add' }]
    },
    'unit_kill_gold': {
        name: '赏金猎人', icon: 'talent_loot',
        description: '以战养战，战斗胜利后额外获得相当于<span class="skill-term-highlight">敌人强度</span><span class="skill-num-highlight">十倍</span>的金钱。',
        requires: ['unit_income_base'],
        effects: [{ type: 'modifier', target: 'hero', key: 'kill_gold', value: 10.0, method: 'percent' }]
    },
    'unit_wood_save': { 
        name: '以物易物', icon: 'talent_wood', 
        description: '<span class="skill-term-highlight">建筑升级所需的木材消耗</span>降低<span class="skill-num-highlight">30%</span>。', 
        requires: ['unit_income_base'],
        effects: [{ type: 'modifier', target: 'global', key: 'building_wood_cost', value: -0.3, method: 'percent' }] 
    },
    'unit_loot_bonus': { 
    ...
    'unit_all_stats_boost': {
        ...
        description: '全面激发潜能，永久提升所有基础属性：<span class="skill-term-highlight">基础属性</span>提升 <span class="skill-num-highlight">12</span> 点，<span class="skill-term-highlight">功法</span>提升 <span class="skill-num-highlight">6</span> 点，<span class="skill-term-highlight">统御</span>提升 <span class="skill-num-highlight">18</span> 点，<span class="skill-term-highlight">最大内力</span>提升 <span class="skill-num-highlight">18</span> 点，<span class="skill-term-highlight">招式调息</span>提升 <span class="skill-num-highlight">3%</span>。',
        requires: ['node_core'],
        effects: [
            { type: 'stat', stat: 'power', value: 12, method: 'add' },
            { type: 'stat', stat: 'spells', value: 6, method: 'add' },
            { type: 'stat', stat: 'leadership', value: 18, method: 'add' },
            { type: 'stat', stat: 'mp', value: 18, method: 'add' },
            { type: 'stat', stat: 'haste', value: 0.03, method: 'add' }
        ]
    },

    // --- 第二组：侠道·统率 (宗门与士气) ---
    'unit_battle_start_buff': { 
        name: '意气风发', icon: 'talent_military_zhangu', 
        description: '战斗开始时，全军获得 <span class="skill-num-highlight">8</span> 秒“振奋”效果，使<span class="skill-term-highlight">移速</span>提升 <span class="skill-num-highlight">20%</span>，<span class="skill-term-highlight">攻速</span>提升 <span class="skill-num-highlight">20%</span>。', 
        requires: ['node_core'],
        effects: [
            { type: 'modifier', target: 'army', key: 'battle_start_haste', value: 0.20, method: 'percent' },
            { type: 'modifier', target: 'army', key: 'battle_start_speed', value: 0.20, method: 'percent' }
        ] 
    },
    'unit_army_def': { 
        name: '万众一心', icon: 'talent_military_budongrushan', 
        description: '众弟子心意相通，气劲连结。全军在战斗中<span class="skill-term-highlight">受到的伤害</span>降低<span class="skill-num-highlight">两成</span>。', 
        requires: ['unit_battle_start_buff'],
        effects: [{ type: 'modifier', target: 'army', key: 'damageReduction', value: 0.2, method: 'add' }] 
    },
    'unit_martyrdom': {
        name: '百战不屈', icon: 'talent_military_pofuchenzhou',
        maxLevel: 2,
        description: '我方成员死前可<span class="skill-term-highlight">强行支撑战斗</span>。每级延长支撑时间 <span class="skill-num-highlight">2</span> 秒。',
        requires: ['unit_army_def'],
        effects: [{ type: 'modifier', target: 'global', key: 'martyrdom_enabled', value: 2000, perLevel: true, method: 'add' }]
    },
    'unit_recruit_save': { 
        name: '名满江湖', icon: 'talent_military_guangmu', 
        description: '门派威名远播，引得四方侠士投奔。<span class="skill-term-highlight">全军招募成本</span>降低<span class="skill-num-highlight">25%</span>。', 
        requires: ['unit_battle_start_buff'],
        effects: [{ type: 'modifier', target: 'global', key: 'recruit_cost', value: -0.25, method: 'percent' }] 
    },
    'unit_elite_cost': { 
        name: '贤能毕至', icon: 'talent_military_mingjiang', 
        description: '德高望重，名动武林。统御占用为 <span class="skill-num-highlight">6</span> 或以上的成名英杰，其<span class="skill-term-highlight">统御占用</span>永久降低 <span class="skill-num-highlight">2</span> 点。', 
        requires: ['unit_morale_base'],
        effects: [{ type: 'modifier', target: 'army', key: 'elite_cost_minus', value: 2, method: 'add' }] 
    },

    // --- 第三组：侠道·逍遥 (探索与回复) ---
    'unit_world_speed_boost': { 
        name: '风驰电掣', icon: 'talent_world_speed', 
        description: '身轻如燕且明察秋毫，<span class="skill-term-highlight">轻功等级</span>永久提升 <span class="skill-num-highlight">4</span> 点，且<span class="skill-term-highlight">迷雾揭开半径</span>增加<span class="skill-num-highlight">八成</span>。', 
        requires: ['unit_kill_gold'],
        effects: [
            { type: 'stat', stat: 'qinggong', value: 4, method: 'add' },
            { type: 'modifier', target: 'global', key: 'reveal_radius', value: 0.8, method: 'percent' }
        ] 
    },
    'unit_season_mp_regen': { 
        name: '千里袭远', icon: 'talent_military_qianli', 
        description: '每当季节更替时，侠客立即<span class="skill-num-highlight">补满内力值与气血值</span>。', 
        requires: ['unit_recruit_save'],
        effects: [
            { type: 'modifier', target: 'hero', key: 'season_mp_regen', value: 1.0, method: 'percent' },
            { type: 'modifier', target: 'hero', key: 'season_hp_regen', value: 1.0, method: 'percent' }
        ] 
    },
    'unit_combo_chain': {
    ...
    'tiance_shout_speed_boost': {
        ...
        description: '【撼如雷】的振奋效果更进一层，每重额外使全军<span class="skill-term-highlight">攻击速度</span>提升 <span class="skill-num-highlight">20%</span>。',
        maxLevel: 3,
        requires: ['tiance_tiger_hp_lock'],
        requiredSkill: 'battle_shout',
        effects: [{ type: 'modifier', target: 'hero', key: 'tiance_shout_haste_enabled', value: 0.2, perLevel: true, method: 'add' }]
    },

    'tiance_tiger_hp_lock': {
        name: '虎啸', icon: 'talent_tiance_3_2',
        description: '【啸如虎】的意志感染全军。锁血阈值从 <span class="skill-num-highlight">1</span> 点提升至最大生命值的 <span class="skill-num-highlight">80%</span>。',
        requires: ['node_core'],
    ...
    'tiance_xu_ru_lin': {
        ...
        description: '徐如林，其寿如山。每重使普通攻击及武学招式释放时，恢复自身<span class="skill-num-highlight">12%</span>的<span class="skill-term-highlight">已损失生命值</span>。',
        maxLevel: 2,
        requires: ['node_core'],
        effects: [{ type: 'modifier', target: 'hero', key: 'tiance_heal_on_cast_factor', value: 0.12, perLevel: true, method: 'add' }]
    },

    'tiance_bleeding_edge': {
        name: '龙牙破军', icon: 'talent_tiance_bleeding',
        description: '所有的武学招式（非普攻）在命中敌人时都会造成伤口，使敌人额外受到共计相当于<span class="skill-term-highlight">该招式伤害</span><span class="skill-num-highlight">45%</span>的<span class="skill-term-highlight">流血伤害</span>，持续 <span class="skill-num-highlight">3</span> 秒。',
        requires: ['tiance_xu_ru_lin'],
    ...
    'cangjian_kill_shield': {
        ...
        description: '重剑之威，势不可挡。重剑形态下，英雄亲手击杀敌方单位后，每重获得相当于自身最大生命值 <span class="skill-num-highlight">8%</span> 的护盾，持续 <span class="skill-num-highlight">2</span> 秒。',
        maxLevel: 2,
        requires: ['node_core'],
        effects: [{ type: 'modifier', target: 'hero', key: 'cangjian_kill_shield_enabled', value: 0.08, perLevel: true, method: 'add' }]
    },
    'cangjian_heavy_burst': {
        name: '莺鸣柳浪', icon: 'talent_cangjian_burst',
        description: '重剑之威，更进一层。重剑形态下的普通攻击次数由 <span class="skill-num-highlight">3</span> 段提升至 <span class="skill-num-highlight">5</span> 段。',
        requires: ['cangjian_kill_shield'],
        effects: [{ type: 'modifier', target: 'hero', key: 'yeying_heavy_burst_bonus', value: 2, method: 'add' }]
    },
    'cangjian_jump_whirlwind': {
        name: '层云', icon: 'talent_cangjian_jump',
        description: '大巧不工。使用鹤归孤山或松舍问霞落地 <span class="skill-num-highlight">0.5</span> 秒后，会自动触发一次额外的旋风斩，造成 <span class="skill-num-highlight">50</span> 点取决于<span class="skill-term-highlight">功法</span>的伤害。',
        requires: ['cangjian_kill_shield'],
    ...
    'cangjian_fenglai_heavy': {
        ...
        description: '【绝技强化】大巧不工，重剑之极。风来吴山的<span class="skill-term-highlight">持续时间</span>延长 <span class="skill-num-highlight">4</span> 秒，且其<span class="skill-term-highlight">范围</span>大幅提升。',
        requires: ['cangjian_jump_whirlwind'],
        requiredSkill: 'fenglaiwushan',
        effects: [
            { type: 'modifier', target: 'hero', key: 'skill_fenglaiwushan_duration_offset', value: 4000, method: 'add' },
            { type: 'modifier', target: 'hero', key: 'skill_fenglaiwushan_radius_multiplier', value: 1.5, method: 'mult' }
        ]
    },
    'cangjian_tingying': {
        name: '听莺', icon: 'talent_cangjian_tingying',
        description: '【西子情】泉凝月的<span class="skill-term-highlight">护盾基础值</span>提高至最大生命值的 <span class="skill-num-highlight">100%</span>，且<span class="skill-term-highlight">持续时间</span>延长至 <span class="skill-num-highlight">6</span> 秒。',
        requires: ['cangjian_fengming'],
        effects: [
            { type: 'modifier', target: 'hero', key: 'skill_quanningyue_percent_override', value: 1.0, method: 'add' },
            { type: 'modifier', target: 'hero', key: 'skill_quanningyue_duration_override', value: 6000, method: 'add' }
        ]
    },
    'cangjian_pianyu': {
        name: '片玉', icon: 'talent_cangjian_pianyu',
        description: '【问水决】梦泉虎跑期间的<span class="skill-term-highlight">受到的伤害</span>额外降低，使总减伤效果提升至 <span class="skill-num-highlight">90%</span>。',
        requires: ['cangjian_tingying'],
        effects: [
            { type: 'modifier', target: 'hero', key: 'skill_mengquan_dr_override', value: 0.9, method: 'add' }
        ]
    },
    ...
    'chunyang_array_duration': {
        ...
        description: '道法自然，生生不息。所有<span class="skill-term-highlight">气场</span>类招式的<span class="skill-term-highlight">持续时间</span>延长 <span class="skill-num-highlight">4</span> 秒。',
        requires: ['node_core'],
        effects: [{ type: 'modifier', target: 'hero', key: 'category_气场_duration_offset', value: 4000, method: 'add' }]
    },
    'chunyang_array_radius': {
        name: '广域', icon: 'talent_chunyang_guangyu',
        description: '乾坤之内，皆为道场。所有<span class="skill-term-highlight">气场</span>类招式的<span class="skill-term-highlight">影响半径</span>提升 <span class="skill-num-highlight">50%</span>。',
        requires: ['chunyang_array_duration'],
        effects: [{ type: 'modifier', target: 'hero', key: 'category_气场_radius_multiplier', value: 1.5, method: 'mult' }]
    },
    'chunyang_huasanqing_permanent': {
        name: '化三清·延', icon: 'talent_chunyang_huasanqing_yan',
        description: '悟彻三清，气劲延绵。<span class="skill-term-highlight">化三清</span>的<span class="skill-term-highlight">持续时间</span>变为<span class="skill-num-highlight">永久</span>。',
        requires: ['chunyang_array_duration'],
    ...
    'unit_chunyang_field_damage': {
        ...
        description: '道法自然，天道昭彰。所有<span class="skill-term-highlight">气场</span>内的敌人每秒受到 <span class="skill-num-highlight">8</span> 点取决于<span class="skill-term-highlight">功法</span>的伤害。',
        requires: ['chunyang_array_radius'],
        effects: [{ type: 'modifier', target: 'hero', key: 'chunyang_field_damage_enabled', value: 8, method: 'add' }]
    },
    'chunyang_array_mana_regen': {
        name: '坐忘无我', icon: 'talent_chunyang_zuowang',
        description: '坐忘玄机，物我两忘。侠客在<span class="skill-term-highlight">气场</span>范围内时，每秒额外<span class="skill-term-highlight">恢复内力</span> <span class="skill-num-highlight">10</span> 点。',
        requires: ['chunyang_array_duration'],
        effects: [{ type: 'modifier', target: 'hero', key: 'chunyang_array_mp_regen_enabled', value: 10, method: 'add' }]
    },
    'chunyang_sanqing_huashen_permanent': {
        name: '三清化神·恒', icon: 'talent_chunyang_sanqing_hen',
        description: '玄门化神，剑气长存。<span class="skill-term-highlight">三清化神</span>的<span class="skill-term-highlight">持续时间</span>变为<span class="skill-num-highlight">永久</span>。',
    ...
    'chunyang_sanqing_huashen_mastery': {
        ...
        description: '三清造化，神技自成。<span class="skill-term-highlight">三清化神</span>的<span class="skill-term-highlight">内力消耗</span>降低为 <span class="skill-num-highlight">0</span>，且发射<span class="skill-term-highlight">间隔</span>缩短 <span class="skill-num-highlight">1.5</span> 秒。',
        ...
        effects: [
            ...
            { type: 'modifier', target: 'hero', key: 'skill_sanqing_huashen_interval_offset', value: -1500, method: 'add' }
        ]
    },
    'chunyang_sword_penetration': {
        name: '万剑归宗', icon: 'talent_chunyang_wanjian',
        description: '心剑合一，气剑纵横。普通攻击获得<span class="skill-term-highlight">无限穿透</span>效果。',
        maxLevel: 1,
        requires: ['chunyang_sword_haste'],
        effects: [
            { type: 'modifier', target: 'hero', key: 'projectile_penetration', value: 15, method: 'add' }
        ]
    },
    'chunyang_sword_range_boost': {
        name: '气御千里', icon: 'talent_haste_epic',
        description: '以气御剑，决胜千里。普通攻击的<span class="skill-term-highlight">攻击范围</span>额外提高 <span class="skill-num-highlight">50%</span>。',
        maxLevel: 1,
        requires: ['chunyang_sword_haste'],
        effects: [
            { type: 'modifier', target: 'hero', key: 'attackRange', value: 0.5, method: 'percent' }
        ]
    },
    'chunyang_sword_damage_boost': {
        name: '气贯长虹', icon: 'talent_chunyang_qiguan',
        maxLevel: 2,
        description: '浩然正气，气贯长虹。普通攻击造成的<span class="skill-term-highlight">伤害</span>提升，<span class="skill-num-highlight">每级使得伤害为原本的 1.2 倍</span>。',
        requires: ['unit_power_epic'],
        effects: [
            { type: 'modifier', target: 'hero', key: 'more_damage', value: 0.2, method: 'percent', perLevel: true }
        ]
    },
    'chunyang_sword_haste': {
        name: '剑影随心', icon: 'talent_chunyang_jianyue',
        maxLevel: 3,
        description: '剑随意动，身随气行。普通攻击的<span class="skill-term-highlight">攻击速度</span>提升 <span class="skill-num-highlight">20%</span>。',
        requires: ['chunyang_sword_damage_boost'],
        effects: [
            { type: 'modifier', target: 'hero', key: 'attackSpeed', value: 0.2, perLevel: true, method: 'percent' }
        ]
    },
    ...
    'unit_power_base': { 
        ...
        icon: 'talent_power', 
        description: '<span class="skill-term-highlight">基础属性</span>提升 <span class="skill-num-highlight">50</span> 点', 
        requires: ['unit_all_stats_boost'],
        effects: [{ type: 'stat', stat: 'power', value: 50, perLevel: true, method: 'add' }] 
    },
    'unit_spells_base': { 
        name: '功法', 
        icon: 'talent_spell_power', 
        description: '<span class="skill-term-highlight">功法</span>提升 <span class="skill-num-highlight">30</span> 点', 
        requires: ['unit_all_stats_boost'],
        effects: [{ type: 'stat', stat: 'spells', value: 30, perLevel: true, method: 'add' }] 
    },
    'unit_leadership_base': { 
        name: '统御', 
        icon: 'talent_leadership', 
        description: '<span class="skill-term-highlight">统御</span>提升 <span class="skill-num-highlight">40</span> 点', 
        requires: ['unit_all_stats_boost'],
        effects: [{ type: 'stat', stat: 'leadership', value: 40, perLevel: true, method: 'add' }] 
    },
    'unit_army_hp': { 
        name: '士气', 
        icon: 'talent_army_hp', 
    ...
    'unit_haste_base': {
        ...
        icon: 'talent_haste', 
        maxLevel: 3,
        description: '<span class="skill-term-highlight">招式调息</span>提升 <span class="skill-num-highlight">10%</span>', 
        requires: ['unit_all_stats_boost'],
        effects: [{ type: 'stat', stat: 'haste', value: 0.1, perLevel: true, method: 'add' }] 
    },
    'unit_mp_base': {
        name: '内力',
        icon: 'talent_mp',
        description: '<span class="skill-term-highlight">最大内力</span>提升 <span class="skill-num-highlight">160</span> 点',
        requires: ['unit_all_stats_boost'],
        effects: [{ type: 'stat', stat: 'mp', value: 160, perLevel: true, method: 'add' }]
    },
    'unit_morale_base': {
        name: '威震四海',
        icon: 'talent_military_wanli',
        description: '<span class="skill-term-highlight">士气</span>提升 <span class="skill-num-highlight">25</span> 点。',
        requires: ['unit_battle_start_buff'],
        effects: [{ type: 'stat', stat: 'morale', value: 25, perLevel: true, method: 'add' }]
    },
    ...
    'unit_power_epic': {
        ...
        description: '突破肉身极限，<span class="skill-term-highlight">基础属性</span>爆发式提升 <span class="skill-num-highlight">70</span> 点。',
        requires: ['cangjian_fengming'],
        effects: [{ type: 'stat', stat: 'power', value: 70, method: 'add' }]
    }
};
...
export const TALENT_GROUPS = {
    ...
    'group_military': {
        name: '侠道·统率',
        tag: '统御',
        major: 'unit_battle_start_buff', // 激励士气作为中心
        minors: ['unit_army_def', 'unit_martyrdom', 'unit_morale_base', 'unit_elite_cost', 'unit_recruit_save', 'unit_season_mp_regen'] 
    },
    // 【属性】全属性基础强化
    'group_attributes': {
        name: '根骨·造化',
    ...
    'group_chunyang_sword': {
        ...
        minors: ['chunyang_sword_damage_boost', 'chunyang_sword_haste', 'chunyang_sanqing_huashen_permanent', 'chunyang_sanqing_huashen_mastery', 'chunyang_sword_penetration', 'chunyang_sword_range_boost']
    }
};
