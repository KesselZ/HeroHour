...
export const UNIT_STATS_DATA = {
    ...
    'cangyun': { name: '苍云将士', hp: 300, atk: 14, range: 0.8, rangeType: '盾墙', speed: 3.4, attackSpeed: 1200, targets: 1.2, description: '玄甲军魂，战场上最难以逾越的铁壁。' },
    ...
    'bandit': { name: '山贼刀匪', hp: 95, atk: 8, range: 0.8, rangeType: '近战', speed: 5.0, attackSpeed: 1000, targets: 1.0 },
    'bandit_archer': { name: '山贼弩匪', hp: 85, atk: 12, range: 8.0, rangeType: '远程', speed: 5.0, attackSpeed: 2000, targets: 1.0 },
    'rebel_soldier': { name: '叛军甲兵', hp: 100, atk: 10, range: 0.8, rangeType: '近战', speed: 4.2, attackSpeed: 1000, mass: 1.5, targets: 1.0 },
    'rebel_axeman': { name: '叛军斧兵', hp: 135, atk: 12, range: 0.8, rangeType: '近战', speed: 5.0, attackSpeed: 1000, targets: 1.0 },
    'snake': { name: '毒蛇', hp: 30, atk: 4, range: 0.6, rangeType: '近战', speed: 5.9, attackSpeed: 1000, targets: 1.0 },
    'bats': { name: '蝙蝠群', hp: 20, atk: 3, range: 0.5, rangeType: '近战', speed: 8.4, attackSpeed: 1000, targets: 1.0 },
    'deer': { name: '林间小鹿', hp: 80, atk: 1, range: 0.5, rangeType: '近战', speed: 8.4, attackSpeed: 1000, targets: 1.0 },
    'pheasant': { name: '山鸡', hp: 30, atk: 1, range: 0.4, rangeType: '近战', speed: 6.7, attackSpeed: 1000, targets: 1.0 },
...
export const UNIT_COSTS = {
    ...
    'bandit': { gold: 65, cost: 2 },
    'bandit_archer': { gold: 55, cost: 3 },
    'rebel_soldier': { gold: 65, cost: 3 },
    'rebel_axeman': { gold: 85, cost: 3 },
