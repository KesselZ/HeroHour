...
export const UNIT_STATS_DATA = {
    ...
    'cj_xinjian': { name: '灵峰侍剑师', hp: 320, atk: 20, range: 12.0, rangeType: '远程', speed: 3.8, attackSpeed: 1200, targets: 1.8, penetration: 2, allowedZones: ['middle'], description: '藏剑门客，感悟西湖灵峰剑意，能凝聚金色气剑点射敌军。' },
    ...
    'cy_zixia_disciple': { name: '紫霞功真传弟子', hp: 240, atk: 9, range: 12.0, rangeType: '远程爆发', speed: 3.5, attackSpeed: 1200, targets: 3.0, burstCount: 3, allowedZones: ['middle'], description: '气宗真传，能够连续发射三枚气剑压制敌人。' },
    ...
    'zombie': { name: '毒尸傀儡', hp: 250, atk: 10, range: 1.2, rangeType: '近战', speed: 2.0, attackSpeed: 1000, targets: 1.0, allowedZones: ['front'] },
    ...
    // --- 天策扩充势力 (强度/Cost 4-15) ---
    'tc_crossbow': { name: '天策羽林弩手', hp: 140, atk: 26, range: 18.0, rangeType: '远程', speed: 3.2, attackSpeed: 2800, targets: 1.5, allowedZones: ['back'], description: '威力巨大的劲弩，装填虽慢但足以致命。' },
    ...
    'tc_mounted_crossbow': { name: '骁骑弩手', hp: 640, atk: 26, range: 14.0, rangeType: '骑射', speed: 6.5, attackSpeed: 2000, targets: 3.0, allowedZones: ['back'], description: '羽林骑精锐，在马上亦能精准射杀敌军。' },
